...
def Addition(pc,ins):
     global d
     #print('Addition')
     #print(ins[13:16],'=',d[ins[7:10]],'+',d[ins[10:13]],':',end=' ')
...
def mov_reg(pc,ins):
     global d
     if(ins[10:13]=='111'):
          d[ins[13:16]]=decimal(d[ins[10:13]])
     else:
          d[ins[13:16]]=d[ins[10:13]]
     d['111']='0'*16
     pc+=1
     lst=[pc,d['000'],d['001'],d['010'],d['011'],d['100'],d['101'],d['110'],d['111']]
     return lst
...
def store(pc,ins):
     ...
     d[ins[8:]]=d[ins[5:8]]
     #print(ins)
     #print(ins[8:],d[ins[8:]],'=',ins[5:8],d[ins[8:]])
     d['111']='0'*16
     pc+=1
     lst=[pc,d['000'],d['001'],d['010'],d['011'],d['100'],d['101'],d['110'],d['111']]
     return lst
...
def Compares(pc,ins):
     global d
     #print("pc:",pc,ins[:5],ins[10:13],ins[13:16])
...
def take_input():
     ...
     for line in sys.stdin:
        if(len(line[:-1])!=16 and len(line[:-1])!=0):
...
def main():
   ...
   #  d={'000':r0,'001':r1,'010':r2,'011':r3,'100':r4,'101':r5,'110':r6,'111':flag}
     ...
     for i in range(len(getdata)):
          y_axis.append(i)
     for i in range(1,len(mem_list)+1):
          y_axis.append(len(getdata)+i)
     #print(x_axis)
     #print(y_axis)
     #graph.scatter(x_axis,y_axis)
     #graph.show()
     #print(x_axis)
     #print(y_axis)
